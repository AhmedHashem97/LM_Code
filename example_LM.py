...
file_path = 'EUPVSEC data_Ahmad.xlsx'
sheet_name = 'HJT-1'
df = pd.read_excel(file_path, sheet_name=sheet_name)
start_row = 2
#------------------------- STC -------------------------
column_name = "G(W/m2).21"
column_name2 = "T.21"
V_0 = df.loc[start_row:, column_name]
I_0 = df.loc[start_row:, column_name2]
V_0.reset_index(drop=True, inplace=True)
I_0.reset_index(drop=True, inplace=True)

V_0=array_float64 = V_0.values.astype('float64').reshape(-1, 1)
I_0=array_float64 = I_0.values.astype('float64').reshape(-1, 1)
